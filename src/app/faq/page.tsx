        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li><span className="font-semibold">Руководитель</span> может инициировать изменение ставки часа (в большую или меньшую сторону) через запрос к <span className="font-semibold">Администратору</span>.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              ...
              <li>Раздел «Штат» — просмотр для <span className="font-semibold">Руководителей</span>; полное управление у <span className="font-semibold">Администратора</span>.</li>
